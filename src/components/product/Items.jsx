...
function Items() {
  ...
  return (
    <>
      <div className="flex flex-col items-center xl:flex xl:flex-col xl:justify-center xl:items-center">
          ...
          {slice.map((data, index) => {
            ...
            return (
              ...
              >
                ...
                <h2 className="font-sans text-sm xl:font-sans xl:pl-3">{title}</h2>
